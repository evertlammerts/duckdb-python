...
class TestRelationDependencyMemoryLeak:
    def test_from_arrow_leak(self, duckdb_cursor):
        if not can_run:
            return
        check_memory(from_arrow, duckdb_cursor)
