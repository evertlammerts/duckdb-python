...
class TestArrowFilterPushdown:
    ...
    def test_9371(self, duckdb_cursor, tmp_path):
        ...
        res = duckdb_cursor.execute("SELECT * FROM my_arrow_dataset WHERE ts = ?", parameters=[dt]).arrow_table()
    ...
    def test_filter_pushdown_2145(self, duckdb_cursor, tmp_path, create_table):
        ...
        table = duckdb_cursor.read_parquet(glob_pattern.as_posix()).arrow_table()
    ...
    def test_filter_pushdown_not_supported(self):
        ...
        arrow_tbl = con.execute("FROM T").arrow_table()
        ...
        arrow_tbl = con.execute("FROM T_2").arrow_table()
    ...
    def test_join_filter_pushdown(self, duckdb_cursor):
        ...
        duck_probe_arrow = duck_probe.arrow_table()
        duck_build_arrow = duck_build.arrow_table()
    ...
    def test_nan_filter_pushdown(self, duckdb_cursor):
        ...
        arrow_table = duckdb_cursor.table("test").arrow_table()
